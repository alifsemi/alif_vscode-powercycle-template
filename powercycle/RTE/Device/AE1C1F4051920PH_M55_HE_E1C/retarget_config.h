...
#define XSTR(x)                                                 STR(x)
    ...
    #error " ***** [RETARGET-FAILED] POLLING MODE IS NOT ENABLED (Enable Polling mode in RTE_Device.h) !!! ****** \n"
        ...
        #define PRINTF_UART_CONSOLE_RX_PADCTRL                      PADCTRL_READ_ENABLE
        #define PRINTF_UART_CONSOLE_TX_PADCTRL                      0
    #elif (PRINTF_UART_CONSOLE == 6) || (PRINTF_UART_CONSOLE == 7)
        #define PRINTF_UART_CONSOLE_PORT_NUM                        0
        #define PRINTF_UART_CONSOLE_RX_PIN                          0
        #define PRINTF_UART_CONSOLE_TX_PIN                          0
        #define PRINTF_UART_CONSOLE_RX_PINMUX_FUNCTION              0
        #define PRINTF_UART_CONSOLE_TX_PINMUX_FUNCTION              0
        #define PRINTF_UART_CONSOLE_RX_PADCTRL                      0
        #define PRINTF_UART_CONSOLE_TX_PADCTRL                      0
        #pragma  message("E1C Board doesn't support UART" XSTR(PRINTF_UART_CONSOLE))
        #error "!!! Please Configure Correct UART for Re-targetting (UART0/1/2/3/4/5/LPUART) \n"
